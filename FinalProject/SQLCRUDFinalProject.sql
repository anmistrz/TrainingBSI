...
INSERT INTO PaymentHistory (PurchaseID, PaymentNominal, PaymentType, PaymentDate)
VALUES
(3, 10000000, 'Transfer Cicilan 1', GETDATE());

--INSERT INTO Customer (FirstName, LastName, PhoneNumber, Address)
--VALUES
--('Anas', 'Ardiansyah', '0834567891345', 'Jl. Mawar No.8, Surabaya');



--INSERT INTO LetterOfIntent (FixPrice, Discount, DownPayment, Description)
--VALUES
--(720000000, 0.07, 45000000, 'LOI untuk pembelian Dummy Mobile 2');

--INSERT INTO Agreement (CustomerID, DealerCarID ,SalesPersonID, LoiID, MethodPayment, BookingFee, AgreementDate)
--VALUES
--(4, 3, 3, 6, 'Credit', 3000000, GETDATE());